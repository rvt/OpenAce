...
TEST_CASE( "RatePerSecond", "[single-file]" )
{
    ...
    float result=0;
    // 5m/s == 984feet/min
    printf(" %f %f %d\n", filter(500+meter*1), filter.perSecond() * MS_TO_FTPMIN, meter); meter++;
    printf(" %f %f %d\n", filter(500+meter*1), filter.perSecond() * MS_TO_FTPMIN, meter); meter++;
    printf(" %f %f %d\n", filter(500+meter*1), filter.perSecond() * MS_TO_FTPMIN, meter); meter++;
    printf(" %f %f %d\n", filter(500+meter*1), filter.perSecond() * MS_TO_FTPMIN, meter); meter++;
    printf(" %f %f %d\n", result = filter(500+meter*1), filter.perSecond() * MS_TO_FTPMIN, meter); meter++;
    ...
    printf(" %f %f %d\n", filter(500+meter), filter.perSecond() * MS_TO_FTPMIN, meter);
    printf(" %f %f %d\n", filter(500+meter), filter.perSecond() * MS_TO_FTPMIN, meter);
    printf(" %f %f %d\n", filter(500+meter), filter.perSecond() * MS_TO_FTPMIN, meter);
    printf(" %f %f %d\n", filter(500+meter), filter.perSecond() * MS_TO_FTPMIN, meter);
    printf(" %f %f %d\n", result = filter(500+meter), filter.perSecond() * MS_TO_FTPMIN, meter);
